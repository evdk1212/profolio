...
import { MainPageTextAnimation } from "@/components/animations/mainPageTextAnimation"
  ...
  return (
    <div>
        ...
        <div className="h-full max-w-2xl mx-auto flex flex-col items-center justify-center gap-10 text-white">
            ...
            <div className=" text-2xl text-center font-bold md:hidden">Only 2% of resumes make it past the first round. Be in the top 2%</div>
            <div className="hidden md:block"><MainPageTextAnimation text="Only 2% of resumes make it past the first round. Be in the top 2%"/></div>
